...
public class NemoBlock {
    ...
    final static int COLORED_RIGHT = 1;
    ...
    public void setColoredByHint(boolean coloredByHint){
        isColoredByHint = coloredByHint; }

    public boolean getColoredByHint(){
        return isColoredByHint; }
}
